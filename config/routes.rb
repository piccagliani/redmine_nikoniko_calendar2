...
match 'projects/:project_id/nikoniko_calendar/history(/:year/:month)', :controller => :nikoniko_calendar_project, :action => :history, :via => :get, :constraints => {:year => /[0-9]{4}/, :month => /[0-9]{1,2}/}, :as => "nikoniko_calendar_project_history"
